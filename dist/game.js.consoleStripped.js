...
(this.dojoConfig || this.djConfig || this.require || {}, {
		...
		packages:[
				...
				{
					 location:"../firefox-install",
					 name:"firefox-install"
				},
				{
					 location:"../firefox-landscape",
...
'firefox-landscape/main':function(){
define(function(){
  ...
  var box = new Box({
    ...
    contactListener: new Contact({
      beginContact: function(idA, idB, contact){
        0 && console.log(contact.IsSensor());
        if(!contact.IsSensor()){
          return;
        }
...
define([
  ...
  var IMPULSE_PER_PIXEL = 0.066666667 * 2;
  ...
  return function(im){
    ...
    if(ball && (this.ui.scoreTime <= 0)){
      ...
      if(!im.mouseAction.isPressed() && position){
        ...
        0 && console.log('hit', angle, impulse);
    ...
    if(ball && (this.ui.scoreTime <= 0)){
      ...
      if(ball.touching.goal){
        ...
        if(velocity < level.maxGoalVelocity){
          ...
          0 && console.log('too hard', velocity);
...
define([
  ...
  'use strict';
   ...
   0 && has.add('debug', function(global){
...
'game/getHoleScoreName':function(){
define(function(){
